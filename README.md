...
**Note**: Requires [Go 1.23.11](https://golang.org/dl/). The mainnet binary in the releases is built with `Go 1.23.11` so if you plan on building from source please use that version!
...
Please refer to [validator operators guide](https://nym.com/docs/operators/nodes/validator-setup) for setup instructions.
